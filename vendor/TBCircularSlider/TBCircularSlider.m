...
//** Draw the circle (using a clipped gradient) **/
    ...
    CGContextAddArc(imageCtx, self.frame.size.width/2  , self.frame.size.height/2, radius, ToRad(-180), ToRad(self.angle), 1);
    [[UIColor redColor]set];
    
    //Use shadow to create the Blur effect
    CGContextSetShadowWithColor(imageCtx, CGSizeMake(0, 0), 8, [UIColor blackColor].CGColor);
